...
[Макет](https://www.figma.com/design/50YEgxY8IYDYj7UQu7yChb/%D0%92%D0%B5%D0%B1-%D0%BB%D0%B0%D1%80%D1%91%D0%BA?node-id=0-1&node-type=canvas&t=7atFCN9Qp2PgVjIP-0)

Проект написан на чистом TypeScript. В соответствии с макетом реализованы следующие задачи:
- спроектирована и задокументирована MVC архитектура в соответствии с принципами ООП, SOLID, KISS, DRY
- реализованы необходимые типы данных, интерфейсы и классы
- реализована функциональность просмотра карточек товаров, открытия, добавления и удаления их из корзины
- реализована логика открытия и закрытия модальных окон
- созданы формы для заполнения информации о доставке и настроена их валидация
- проект интегрирован с API
